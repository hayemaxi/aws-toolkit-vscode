...
import { NotificationsController, RuleEngine, RuleContext, registerProvider } from 'aws-core-vscode/notifications'
...
export async function activateAmazonQCommon(context: vscode.ExtensionContext, isWeb: boolean) {
    ...
    registerToolView(
        {
            nodes: [new NotificationsNode('amazonq')],
    ...
    const controller = new NotificationsController('amazonq', NotificationsNode.instance)
